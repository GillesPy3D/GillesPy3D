...
from model_builder.handlers import GillesPy3DBase
from model_builder.handlers.util.model_builder_errors import GillesPy3DFileNotFoundError, FileNotJSONFormatError, \
...
class TestGillesPy3DBaseObject(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if GillesPy3DBase.user_dir != os.path.expanduser("~"):
    ...
    def test_add_presentation_name__file_exists(self):
        ...
        GillesPy3DBase.user_dir = self.tempdir.name
        test_base = GillesPy3DBase(path="")
    ...
    def test_check_project_format__old_with_mdl(self):
        ...
        for test_file in test_files:
            with self.subTest(test_file=test_file):
                ...
                self.assertFalse(GillesPy3DBase.check_project_format(path=self.test_folderpath))
                self.tearDown()
                self.setUp()
    ...
    def test_check_workflow_format__old_with_old_files(self):
        ...
        for test_file in test_files:
            with self.subTest(test_file=test_file):
                test_file_path = os.path.join(self.test_folderpath, test_file)
                Path(test_file_path).touch()
                self.assertFalse(GillesPy3DBase.check_workflow_format(path=self.test_folderpath))
                self.tearDown()
                self.setUp()
    ...
    def test_get_new_path(self):
        ...
        test_file_path = GillesPy3DBase.get_new_path(dst_path=test_dst_path)
    ...
    def test_get_new_path__no_trash_folder(self):
        ...
        GillesPy3DBase.user_dir = self.test_folderpath
        GillesPy3DBase.get_new_path(dst_path=test_dst_path)
    ...
    def test_get_file__no_path_passed(self):
        ''' Check if the file from self.path of GillesPy3DBase is returned. '''
    ...
    def test_get_model_template__as_dict(self):
        ...
        test_base = GillesPy3DBase(path=self.test_filepath)
    ...
    def test_get_model_template__file_not_found_error(self):
        ''' Check if the GillesPy3DFileNotFoundError is raised when the template file is missing. '''
        test_base = GillesPy3DBase(path=self.test_filepath)
    ...
    def test_get_name__no_path_passed(self):
        ...
        for test_path in test_paths:
            with self.subTest(test_path=test_path):
                test_base = GillesPy3DBase(path=test_path)
    ...
    def test_get_dir_name__with_out_user_dir__root(self):
        ...
        test_base = GillesPy3DBase(path="test_file")
    ...
    def test_get_dir_name__with_out_user_dir__not_root(self):
        ...
        test_base = GillesPy3DBase(path="test_folder/test_file")
    ...
    def test_get_status__file_not_found_error(self):
        ''' Check if the GillesPy3DFileNotFoundError is raised when the job is missing. '''
        test_base = GillesPy3DBase(path=self.test_folderpath)
    ...
    def test_get_unique_path__with_out_dirname__dirname_is_root__unique(self):
        ...
        for test_file in test_files:
            with self.subTest(test_file=test_file):
                test_base = GillesPy3DBase(path="test_base_file")
    ...
    def test_get_unique_path__with_out_dirname__dirname_not_root__unique(self):
        ...
        for test_file in test_files:
            with self.subTest(test_file=test_file):
                ...
                test_base = GillesPy3DBase(path=os.path.join("test_folder/test_base_file"))
                test_base.user_dir = self.test_folderpath
                unique_path, changed = test_base.get_unique_path(name=test_file)
                self.assertFalse(changed)
    ...
    def test_get_unique_path__with_out_dirname__dirname_not_root__first_iter_removed(self):
        ...
        for i, test_file in enumerate(test_files):
            with self.subTest(test_file=test_file):
                ...
                test_base = GillesPy3DBase(path="test_folder/test_base_file")
                test_base.user_dir = self.test_folderpath
                unique_path, changed = test_base.get_unique_path(name=test_file)
                self.assertTrue(changed)
                self.assertEqual(unique_path, os.path.join(self.test_folderpath, "test_folder", expected_results[i]))
    ...
    def test_get_unique_copy_path__with_out_path__dirname_not_root__one_iter(self):
        ...
        for i, test_file in enumerate(test_files):
            with self.subTest(test_file=test_file):
                os.mkdir(os.path.join(self.test_folderpath, "test_folder"))
                test_base = GillesPy3DBase(path=os.path.join("test_folder", test_file))
                test_base.user_dir = self.test_folderpath
                unique_copy_path = test_base.get_unique_copy_path()
    ...
    def test_make_parent_dirs__one_missing_dir(self):
        ...
        test_base = GillesPy3DBase(path=self.test_folderpath)
        with mock.patch('model_builder.handlers.util.GillesPy3DBase.get_dir_name') as mock_get_dir_name:
    ...
    def test_rename__file_not_found_error(self):
        ''' Check if the GillesPy3DFileNotFoundError is raised when the file is missing. '''
        test_base = GillesPy3DBase(path="test_file")
        with self.assertRaises(GillesPy3DFileNotFoundError):
