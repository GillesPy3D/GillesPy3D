...
class StochSSBase():
    ...
    def __build_html_entry(cls, entry, home):
        ...
        nav_link = f"model_builder/project/manager?path=Examples/{entry['name']}.proj"
    ...
    def get_model_template(self, as_string=False):
        '''
        Get the model_builder model template
    ...
    def get_settings_template(self, as_string=False):
        ...
        as_string : bool
            Indicates whether or not to return the template in string format
        '''
        path = '/model_builder/model_builder_templates/workflowSettingsTemplate.json'
    ...
    def load_user_settings(self, path=None):
        ...
        if path is None and os.path.exists(self.path):
            ...
            path = "/model_builder/model_builder_templates/userSettingTemplate.json"
