...
class StochSSFolder(GillesPy3DBase):
    ...
    def __get_file_from_link(self, remote_path):
        ...
        if os.path.exists("/model_builder/.proxies.txt"):
            with open("/model_builder/.proxies.txt", "r", encoding="utf-8") as proxy_file:
        ...
        try:
            ...
            for file in files:
                ...
                presentation = {
                    ...
                    "link": f"/model_builder/{routes[ext]}?owner={hostname}&file={file}",
