...
from model_builder.handlers import StochSSBase
from model_builder.handlers.util.model_builder_errors import StochSSFileNotFoundError, FileNotJSONFormatError, \
...
class TestStochSSBaseObject(unittest.TestCase):
    ...
    def test_make_parent_dirs__one_missing_dir(self):
        ...
        test_base = StochSSBase(path=self.test_folderpath)
        with mock.patch('model_builder.handlers.util.StochSSBase.get_dir_name') as mock_get_dir_name:
