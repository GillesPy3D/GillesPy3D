...
__version__      = '0.1.0'
__title__        = 'GillesPy3D'
__description__  = 'Python Interface for Biochemical Simulations'
__url__          = 'https://gillespy3d.github.io/GillesPy3D'
__download_url__ = 'https://github.com/GillesPy3D/GillesPy3D/tarball/main/'
